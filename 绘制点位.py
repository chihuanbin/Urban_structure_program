...
if __name__ == "__main__":
    ...
    with open('order_20161101_w.csv', 'r+', encoding='utf-8') as f:
        tmp = f.readlines()
    tmp_=pd.read_csv('order_20161101_w.csv',  encoding='utf-8',header=None)
    #["ID","O_time,D_time,lat1,lng1,lat2,lng2"]
    tmp_o=tmp_[3].to_list
    #tmp
    print(tmp_o)
    print(tmp_.head())
    data=np.array([tmp_[3],tmp_[4]]).transpose()
    print(data.shape)
